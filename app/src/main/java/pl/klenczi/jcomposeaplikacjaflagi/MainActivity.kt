package pl.klenczi.jcomposeaplikacjaflagi
...
import pl.klenczi.jcomposeaplikacjaflagi.ui.theme.JComposeAplikacjaFlagiTheme
    ...
    Column (modifier = Modifier.fillMaxSize(),
        ...
        AnimatedVisibility( //wyniki
            ...
            Card(
                ...
                LazyColumn {
                    itemsIndexed(
                        listOf(wynikiString ,"This", "is", "Jetpack", "Compose")
                    ) { index, string ->
                        Text(
                            text = "$string",
                            fontSize = 24.sp,
